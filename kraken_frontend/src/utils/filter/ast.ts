...
/**
 * All the available different ASTs for filters. The values themselves ARE the
 * types, which are used with `typeof` or by just accessing this object.
 */
...
/**
 * The types for each AST column. Corresponds exactly to the columns defined in
 * `ASTFields`. Specified as runtime values to allow easier UI generation as
 * well as disambiguating common types like string which could mean many
 * different things.
 */
