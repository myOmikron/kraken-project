...
export class FindingCategoriesApi extends runtime.BaseAPI {
    ...
    /**
     * Create a finding category.  This action requires admin privileges.
    ...
    /**
     * Delete a finding category  Requires admin privileges.
    ...
    /**
     * Update a finding category  One of the options must be set  Requires admin privileges.
