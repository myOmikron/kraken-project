...
import {
    WsMessageOneOf35,
    WsMessageOneOf35TypeEnum,
    WsMessageOneOf35FromJSONTyped,
    WsMessageOneOf35ToJSON,
} from './WsMessageOneOf35';
import {
    WsMessageOneOf23,
...
import {
    WsMessageOneOf34,
    WsMessageOneOf34TypeEnum,
    WsMessageOneOf34FromJSONTyped,
    WsMessageOneOf34ToJSON,
} from './WsMessageOneOf34';
import {
    WsMessageOneOf1,
...
import {
    WsMessageOneOf32,
    WsMessageOneOf32TypeEnum,
    WsMessageOneOf32FromJSONTyped,
    WsMessageOneOf32ToJSON,
} from './WsMessageOneOf32';
import {
    WsMessageOneOf29,
...
import {
    WsMessageOneOf33,
    WsMessageOneOf33TypeEnum,
    WsMessageOneOf33FromJSONTyped,
    WsMessageOneOf33ToJSON,
} from './WsMessageOneOf33';
import {
    WsMessageOneOf17,
...
const WsMessageOneOf35Type = enumToString(WsMessageOneOf35TypeEnum);
...
const WsMessageOneOf34Type = enumToString(WsMessageOneOf34TypeEnum);
const WsMessageOneOf1Type = enumToString(WsMessageOneOf1TypeEnum);
const WsMessageOneOf32Type = enumToString(WsMessageOneOf32TypeEnum);
const WsMessageOneOf29Type = enumToString(WsMessageOneOf29TypeEnum);
const WsMessageOneOf33Type = enumToString(WsMessageOneOf33TypeEnum);
...
export function WsMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): WsMessage {
    ...
    switch (json['type']) {
        ...
        case WsMessageOneOf35Type:
            return WsMessageOneOf35FromJSONTyped(json, ignoreDiscriminator);
        ...
        case WsMessageOneOf34Type:
            return WsMessageOneOf34FromJSONTyped(json, ignoreDiscriminator);
        case WsMessageOneOf1Type:
            return WsMessageOneOf1FromJSONTyped(json, ignoreDiscriminator);
        case WsMessageOneOf32Type:
            return WsMessageOneOf32FromJSONTyped(json, ignoreDiscriminator);
        case WsMessageOneOf29Type:
            return WsMessageOneOf29FromJSONTyped(json, ignoreDiscriminator);
        case WsMessageOneOf33Type:
            return WsMessageOneOf33FromJSONTyped(json, ignoreDiscriminator);
...
export function WsMessageToJSON(value?: WsMessage | null): any {
    ...
    switch (value['type']) {
        ...
        case WsMessageOneOf35Type:
            return WsMessageOneOf35ToJSON(value);
        case WsMessageOneOf23Type:
        ...
        case WsMessageOneOf34Type:
            return WsMessageOneOf34ToJSON(value);
        case WsMessageOneOf1Type:
            return WsMessageOneOf1ToJSON(value);
        case WsMessageOneOf32Type:
            return WsMessageOneOf32ToJSON(value);
        case WsMessageOneOf29Type:
            return WsMessageOneOf29ToJSON(value);
        case WsMessageOneOf33Type:
            return WsMessageOneOf33ToJSON(value);
        case WsMessageOneOf17Type:
