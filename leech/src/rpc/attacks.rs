...
use kraken_proto::{
    ...
    DnsResolutionResponse, HostsAliveRequest, HostsAliveResponse, ServiceCertainty,
    ServiceDetectionRequest, ServiceDetectionResponse, TcpPortScanRequest, TcpPortScanResponse,
