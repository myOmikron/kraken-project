# Rust API client for kraken_sdk
...
Put the package under your project folder in a directory named `kraken_sdk` and add the following to `Cargo.toml` under `[dependencies]`:

```
kraken_sdk = { path = "./kraken_sdk" }
```
