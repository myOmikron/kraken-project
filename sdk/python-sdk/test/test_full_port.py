...
class TestFullPort(unittest.TestCase):
    """FullPort unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FullPort:
        """Test FullPort
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FullPort`
        """
        model = FullPort()
        if include_optional:
            return FullPort(
