...
class TestFullDecision(unittest.TestCase):
    """FullDecision unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FullDecision:
        """Test FullDecision
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FullDecision`
        """
        model = FullDecision()
        if include_optional:
            return FullDecision(
