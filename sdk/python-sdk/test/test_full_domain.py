...
class TestFullDomain(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FullDomain:
        """Test FullDomain
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FullDomain`
        """
        model = FullDomain()
        if include_optional:
            return FullDomain(
