...
class WordlistApi:
    ...
    async def get_all_wordlists(
        ...
        _param = self._get_all_wordlists_serialize(
    ...
    @validate_call
    async def get_all_wordlists_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_all_wordlists_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_all_wordlists_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/wordlists',
