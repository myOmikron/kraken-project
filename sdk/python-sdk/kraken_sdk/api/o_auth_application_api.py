...
class OAuthApplicationApi:
    ...
    async def create_oauth_app(
        ...
        _param = self._create_oauth_app_serialize(
    ...
    @validate_call
    async def create_oauth_app_with_http_info(
        self,
        create_app_request: CreateAppRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def create_oauth_app_without_preload_content(
        self,
        create_app_request: CreateAppRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_oauth_app_serialize(
        self,
        create_app_request,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/admin/applications',
    ...
    async def delete_oauth_app(
        ...
        _param = self._delete_oauth_app_serialize(
            uuid=uuid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _delete_oauth_app_serialize(
        self,
        uuid,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/admin/applications/{uuid}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_all_oauth_apps(
        ...
        _param = self._get_all_oauth_apps_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def get_all_oauth_apps_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_all_oauth_apps_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_all_oauth_apps_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    async def get_oauth_app(
        ...
        _param = self._get_oauth_app_serialize(
            uuid=uuid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    async def update_oauth_app(
        ...
        _param = self._update_oauth_app_serialize(
            uuid=uuid,
    ...
    def _update_oauth_app_serialize(
        self,
        uuid,
        update_app_request,
        _request_auth,
