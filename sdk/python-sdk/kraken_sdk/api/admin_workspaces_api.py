...
class AdminWorkspacesApi:
    ...
    async def get_all_workspaces_admin(
        ...
        _param = self._get_all_workspaces_admin_serialize(
    ...
    @validate_call
    async def get_all_workspaces_admin_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_all_workspaces_admin_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_all_workspaces_admin_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    async def get_workspace_admin(
        ...
        _param = self._get_workspace_admin_serialize(
            uuid=uuid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_workspace_admin_serialize(
        self,
        uuid,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/admin/workspaces/{uuid}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
