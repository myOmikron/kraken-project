...
class DomainsApi:
    ...
    async def get_domain_relations(
        ...
        _param = self._get_domain_relations_serialize(
            w_uuid=w_uuid,
            d_uuid=d_uuid,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def get_domain_relations_with_http_info(
        self,
        w_uuid: Annotated[StrictStr, Field(description="The workspace's uuid")],
        d_uuid: Annotated[StrictStr, Field(description="The domain's uuid")],
        _request_timeout: Union[
    ...
    @validate_call
    async def get_domain_relations_without_preload_content(
        self,
        w_uuid: Annotated[StrictStr, Field(description="The workspace's uuid")],
        d_uuid: Annotated[StrictStr, Field(description="The domain's uuid")],
        _request_timeout: Union[
    ...
    def _get_domain_relations_serialize(
        self,
        w_uuid,
        d_uuid,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/workspaces/{w_uuid}/domains/{d_uuid}/relations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def get_domain_sources(
        ...
        _param = self._get_domain_sources_serialize(
            w_uuid=w_uuid,
            d_uuid=d_uuid,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def get_domain_sources_with_http_info(
        self,
        w_uuid: Annotated[StrictStr, Field(description="The workspace's uuid")],
        d_uuid: Annotated[StrictStr, Field(description="The domain's uuid")],
        _request_timeout: Union[
    ...
    @validate_call
    async def get_domain_sources_without_preload_content(
        self,
        w_uuid: Annotated[StrictStr, Field(description="The workspace's uuid")],
        d_uuid: Annotated[StrictStr, Field(description="The domain's uuid")],
        _request_timeout: Union[
    ...
    def _get_domain_sources_serialize(
        self,
        w_uuid,
        d_uuid,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/workspaces/{w_uuid}/domains/{d_uuid}/sources',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
