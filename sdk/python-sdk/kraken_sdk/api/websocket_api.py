...
class WebsocketApi:
    ...
    async def websocket(
        ...
        _param = self._websocket_serialize(
    ...
    @validate_call
    async def websocket_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def websocket_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
