...
class WorkspaceInvitationsApi:
    ...
    def _accept_invitation_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/invitations/{uuid}/accept',
    ...
    def _decline_invitation_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/invitations/{uuid}/decline',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def get_all_invitations_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_all_invitations_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
