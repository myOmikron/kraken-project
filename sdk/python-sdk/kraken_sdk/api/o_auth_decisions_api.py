...
class OAuthDecisionsApi:
    ...
    async def get_decisions(
        ...
        _param = self._get_decisions_serialize(
    ...
    @validate_call
    async def get_decisions_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_decisions_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_decisions_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/oauthDecisions',
    ...
    async def revoke_decision(
        ...
        _param = self._revoke_decision_serialize(
            uuid=uuid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _revoke_decision_serialize(
        self,
        uuid,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/oauthDecisions/{uuid}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
