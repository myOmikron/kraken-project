...
class FullWorkspaceInvitation(BaseModel):
    """
    The full representation of an invitation to a workspace
    """ # noqa: E501
    uuid: StrictStr = Field(description="The uuid of the invitation")
    workspace: SimpleWorkspace
    var_from: SimpleUser = Field(alias="from")
    target: SimpleUser
    __properties: ClassVar[List[str]] = ["uuid", "workspace", "from", "target"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "target": SimpleUser.from_dict(obj.get("target")) if obj.get("target") is not None else None
        })
        return _obj
