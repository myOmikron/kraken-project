...
class OpenRequestInfo(BaseModel):
    """
    The information about an oauth request
    """ # noqa: E501
    workspace: SimpleWorkspace
    oauth_application: SimpleOauthClient
    __properties: ClassVar[List[str]] = ["workspace", "oauth_application"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.oauth_application:
            _dict['oauth_application'] = self.oauth_application.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "oauth_application": SimpleOauthClient.from_dict(obj.get("oauth_application")) if obj.get("oauth_application") is not None else None
        })
        return _obj
