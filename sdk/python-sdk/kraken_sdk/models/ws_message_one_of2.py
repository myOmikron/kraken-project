...
class WsMessageOneOf2(BaseModel):
    ...
    finished_successful: StrictBool = Field(description="Whether the attack was finished successful")
    type: StrictStr
    __properties: ClassVar[List[str]] = ["attack_uuid", "finished_successful", "type"]
