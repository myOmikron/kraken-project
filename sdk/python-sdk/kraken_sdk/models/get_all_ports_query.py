...
class GetAllPortsQuery(BaseModel):
    """
    ...
    host: Optional[StrictStr] = Field(default=None, description="Only get ports associated with a specific host")
    global_filter: Optional[StrictStr] = Field(default=None, description="An optional general filter to apply")
    port_filter: Optional[StrictStr] = Field(default=None, description="An optional port specific filter to apply")
    __properties: ClassVar[List[str]] = ["limit", "offset", "host", "global_filter", "port_filter"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if port_filter (nullable) is None
        # and model_fields_set contains the field
        if self.port_filter is None and "port_filter" in self.model_fields_set:
            _dict['port_filter'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "port_filter": obj.get("port_filter")
        })
        return _obj
