...
class WsMessageOneOf16(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('UpdatedGlobalTags'):
            raise ValueError("must be one of enum values ('UpdatedGlobalTags')")
        return value
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WsMessageOneOf16 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WsMessageOneOf16 from a dict"""
        if obj is None:
            return None
