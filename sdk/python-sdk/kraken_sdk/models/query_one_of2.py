...
class QueryOneOf2(BaseModel):
    """
    QueryOneOf2
    """ # noqa: E501
    username: SearchType = Field(alias="Username")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "Username": SearchType.from_dict(obj.get("Username")) if obj.get("Username") is not None else None
        })
        return _obj
