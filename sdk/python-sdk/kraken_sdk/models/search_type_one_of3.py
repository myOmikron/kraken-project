...
class SearchTypeOneOf3(BaseModel):
    """
    SearchTypeOneOf3
    """ # noqa: E501
    var_or: List[SearchType] = Field(description="Add multiple [SearchType]s with an OR", alias="Or")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "Or": [SearchType.from_dict(_item) for _item in obj.get("Or")] if obj.get("Or") is not None else None
        })
        return _obj

from kraken_sdk.models.search_type import SearchType
# TODO: Rewrite to not use raise_errors
SearchTypeOneOf3.model_rebuild(raise_errors=False)
