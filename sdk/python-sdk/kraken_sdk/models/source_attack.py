...
class SourceAttack(SourceAttackResult):
    """
    ...
    __properties: ClassVar[List[str]] = ["attack_type", "results", "uuid", "workspace_uuid", "started_by", "finished_at", "error", "created_at"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SourceAttack from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SourceAttack from a dict"""
        if obj is None:
            return None
