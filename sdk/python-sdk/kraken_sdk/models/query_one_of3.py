...
class QueryOneOf3(BaseModel):
    """
    QueryOneOf3
    """ # noqa: E501
    password: SearchType = Field(alias="Password")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "Password": SearchType.from_dict(obj.get("Password")) if obj.get("Password") is not None else None
        })
        return _obj
