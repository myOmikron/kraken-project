...
class GetAllServicesQuery(BaseModel):
    """
    ...
    host: Optional[StrictStr] = Field(default=None, description="Only get services associated with a specific host")
    global_filter: Optional[StrictStr] = Field(default=None, description="An optional general filter to apply")
    service_filter: Optional[StrictStr] = Field(default=None, description="An optional service specific filter to apply")
    __properties: ClassVar[List[str]] = ["limit", "offset", "host", "global_filter", "service_filter"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if service_filter (nullable) is None
        # and model_fields_set contains the field
        if self.service_filter is None and "service_filter" in self.model_fields_set:
            _dict['service_filter'] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "service_filter": obj.get("service_filter")
        })
        return _obj
