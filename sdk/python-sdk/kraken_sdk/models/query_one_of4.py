...
class QueryOneOf4(BaseModel):
    """
    QueryOneOf4
    """ # noqa: E501
    hashed_password: SearchType = Field(alias="HashedPassword")
    __properties: ClassVar[List[str]] = ["HashedPassword"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "HashedPassword": SearchType.from_dict(obj.get("HashedPassword")) if obj.get("HashedPassword") is not None else None
        })
        return _obj
