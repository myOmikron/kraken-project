...
class BruteforceSubdomainsRequest(BaseModel):
    """
    ...
    domain: StrictStr = Field(description="Domain to construct subdomains for")
    wordlist_uuid: StrictStr = Field(description="The wordlist to use")
    ...
    __properties: ClassVar[List[str]] = ["leech_uuid", "domain", "wordlist_uuid", "concurrent_limit", "workspace_uuid"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "wordlist_uuid": obj.get("wordlist_uuid"),
