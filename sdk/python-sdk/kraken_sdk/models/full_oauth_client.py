...
class FullOauthClient(BaseModel):
    """
    ...
    secret: StrictStr = Field(description="The secret of the client")
    __properties: ClassVar[List[str]] = ["uuid", "name", "redirect_uri", "secret"]
