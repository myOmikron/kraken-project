...
class SearchTypeOneOf4(BaseModel):
    """
    SearchTypeOneOf4
    """ # noqa: E501
    var_and: List[SearchType] = Field(description="Add multiple [SearchType]s with an AND", alias="And")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "And": [SearchType.from_dict(_item) for _item in obj.get("And")] if obj.get("And") is not None else None
        })
        return _obj

from kraken_sdk.models.search_type import SearchType
# TODO: Rewrite to not use raise_errors
SearchTypeOneOf4.model_rebuild(raise_errors=False)
