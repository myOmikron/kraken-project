...
class UpdateHostRequest(BaseModel):
    ...
    """ # noqa: E501
    comment: Optional[StrictStr] = Field(default=None, description="The comment of a host")
    global_tags: Optional[List[StrictStr]] = Field(default=None, description="The global tags of a host")
    workspace_tags: Optional[List[StrictStr]] = Field(default=None, description="The workspace tags of a host")
