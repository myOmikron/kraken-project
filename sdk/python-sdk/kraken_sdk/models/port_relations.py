...
class PortRelations(BaseModel):
    """
    A port's direct relations
    """ # noqa: E501
    host: SimpleHost
    services: List[SimpleService] = Field(description="Services listening on this port")
    __properties: ClassVar[List[str]] = ["host", "services"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of PortRelations from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of PortRelations from a dict"""
        if obj is None:
            return None
