...
class QueryOneOf1(BaseModel):
    """
    QueryOneOf1
    """ # noqa: E501
    ip_address: SearchType = Field(alias="IpAddress")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "IpAddress": SearchType.from_dict(obj.get("IpAddress")) if obj.get("IpAddress") is not None else None
        })
        return _obj
