...
class FullWorkspace(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "attacks": [SimpleAttack.from_dict(_item) for _item in obj.get("attacks")] if obj.get("attacks") is not None else None,
            "members": [SimpleUser.from_dict(_item) for _item in obj.get("members")] if obj.get("members") is not None else None,
