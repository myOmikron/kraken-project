...
class SimpleTcpPortScanResult(BaseModel):
    """
    ...
    address: StrictStr = Field(description="The ip address a port was found on")
    port: Annotated[int, Field(strict=True, ge=0)] = Field(description="The found port")
    __properties: ClassVar[List[str]] = ["uuid", "attack", "created_at", "address", "port"]
