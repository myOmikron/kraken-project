...
impl fmt::Display for Tactic {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            Tactic::CredentialAccess(technique) => technique.fmt(f),
            Tactic::Execution(technique) => technique.fmt(f),
            Tactic::Impact(technique) => technique.fmt(f),
            Tactic::Persistence(technique) => technique.fmt(f),
            Tactic::PrivilegeEscalation(technique) => technique.fmt(f),
            Tactic::LateralMovement(technique) => technique.fmt(f),
            Tactic::DefenseEvasion(technique) => technique.fmt(f),
            Tactic::Exfiltration(technique) => technique.fmt(f),
            Tactic::Discovery(technique) => technique.fmt(f),
            Tactic::Collection(technique) => technique.fmt(f),
            Tactic::ResourceDevelopment(technique) => technique.fmt(f),
            Tactic::Reconnaissance(technique) => technique.fmt(f),
            Tactic::CommandAndControl(technique) => technique.fmt(f),
            Tactic::InitialAccess(technique) => technique.fmt(f),
        }
    }
}
impl fmt::Display for CredentialAccess {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str(match self {
            CredentialAccess::AdversaryInTheMiddle => "Adversary-in-the-Middle",
            CredentialAccess::OsCredentialDumping => "OS Credential Dumping",
            CredentialAccess::StealWebSessionCookie => "Steal Web Session Cookie",
            CredentialAccess::NetworkSniffing => "Network Sniffing",
            CredentialAccess::StealOrForgeKerberosTickets => "Steal or Forge Kerberos Tickets",
            CredentialAccess::CredentialsFromPasswordStores => "Credentials from Password Stores",
            CredentialAccess::UnsecuredCredentials => "Unsecured Credentials",
            CredentialAccess::StealOrForgeAuthenticationCertificates => "Steal or Forge Authentication Certificates",
            CredentialAccess::StealApplicationAccessToken => "Steal Application Access Token",
            CredentialAccess::ForgeWebCredentials => "Forge Web Credentials",
            CredentialAccess::MultiFactorAuthenticationRequestGeneration => "Multi-Factor Authentication Request Generation",
            CredentialAccess::ExploitationForCredentialAccess => "Exploitation for Credential Access",
            CredentialAccess::BruteForce => "Brute Force",
            CredentialAccess::ForcedAuthentication => "Forced Authentication",
            CredentialAccess::InputCapture => "Input Capture",
            CredentialAccess::MultiFactorAuthenticationInterception => "Multi-Factor Authentication Interception",
            CredentialAccess::ModifyAuthenticationProcess => "Modify Authentication Process",
        })
    }
}
impl fmt::Display for Execution {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str(match self {
            Execution::WindowsManagementInstrumentation => "Windows Management Instrumentation",
            Execution::SharedModules => "Shared Modules",
            Execution::ScheduledTaskJob => "Scheduled Task/Job",
            Execution::NativeApi => "Native API",
            Execution::DeployContainer => "Deploy Container",
            Execution::CommandAndScriptingInterpreter => "Command and Scripting Interpreter",
            Execution::ContainerAdministrationCommand => "Container Administration Command",
            Execution::UserExecution => "User Execution",
            Execution::SoftwareDeploymentTools => "Software Deployment Tools",
            Execution::InterProcessCommunication => "Inter-Process Communication",
            Execution::ExploitationForClientExecution => "Exploitation for Client Execution",
            Execution::SystemServices => "System Services",
            Execution::CloudAdministrationCommand => "Cloud Administration Command",
            Execution::ServerlessExecution => "Serverless Execution",
        })
    }
}
impl fmt::Display for Impact {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str(match self {
            Impact::DiskWipe => "Disk Wipe",
            Impact::ServiceStop => "Service Stop",
            Impact::Defacement => "Defacement",
            Impact::FinancialTheft => "Financial Theft",
            Impact::DataManipulation => "Data Manipulation",
            Impact::AccountAccessRemoval => "Account Access Removal",
            Impact::DataEncryptedForImpact => "Data Encrypted for Impact",
            Impact::EndpointDenialOfService => "Endpoint Denial of Service",
            Impact::ResourceHijacking => "Resource Hijacking",
            Impact::DataDestruction => "Data Destruction",
            Impact::NetworkDenialOfService => "Network Denial of Service",
            Impact::FirmwareCorruption => "Firmware Corruption",
            Impact::InhibitSystemRecovery => "Inhibit System Recovery",
            Impact::SystemShutdownReboot => "System Shutdown/Reboot",
        })
    }
}
impl fmt::Display for Persistence {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str(match self {
            Persistence::BootOrLogonInitializationScripts => "Boot or Logon Initialization Scripts",
            Persistence::CreateOrModifySystemProcess => "Create or Modify System Process",
            Persistence::ExternalRemoteServices => "External Remote Services",
            Persistence::BootOrLogonAutostartExecution => "Boot or Logon Autostart Execution",
            Persistence::OfficeApplicationStartup => "Office Application Startup",
            Persistence::ScheduledTaskJob => "Scheduled Task/Job",
            Persistence::BrowserExtensions => "Browser Extensions",
            Persistence::TrafficSignaling => "Traffic Signaling",
            Persistence::ImplantInternalImage => "Implant Internal Image",
            Persistence::PreOsBoot => "Pre-OS Boot",
            Persistence::CompromiseClientSoftwareBinary => "Compromise Client Software Binary",
            Persistence::AccountManipulation => "Account Manipulation",
            Persistence::HijackExecutionFlow => "Hijack Execution Flow",
            Persistence::ValidAccounts => "Valid Accounts",
            Persistence::EventTriggeredExecution => "Event Triggered Execution",
            Persistence::BitsJobs => "BITS Jobs",
            Persistence::ServerSoftwareComponent => "Server Software Component",
            Persistence::CreateAccount => "Create Account",
            Persistence::PowerSettings => "Power Settings",
            Persistence::ModifyAuthenticationProcess => "Modify Authentication Process",
        })
    }
}
impl fmt::Display for PrivilegeEscalation {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str(match self {
            PrivilegeEscalation::BootOrLogonInitializationScripts => "Boot or Logon Initialization Scripts",
            PrivilegeEscalation::CreateOrModifySystemProcess => "Create or Modify System Process",
            PrivilegeEscalation::BootOrLogonAutostartExecution => "Boot or Logon Autostart Execution",
            PrivilegeEscalation::ScheduledTaskJob => "Scheduled Task/Job",
            PrivilegeEscalation::ProcessInjection => "Process Injection",
            PrivilegeEscalation::EscapeToHost => "Escape to Host",
            PrivilegeEscalation::AbuseElevationControlMechanism => "Abuse Elevation Control Mechanism",
            PrivilegeEscalation::AccountManipulation => "Account Manipulation",
            PrivilegeEscalation::HijackExecutionFlow => "Hijack Execution Flow",
            PrivilegeEscalation::ValidAccounts => "Valid Accounts",
            PrivilegeEscalation::ExploitationForPrivilegeEscalation => "Exploitation for Privilege Escalation",
            PrivilegeEscalation::EventTriggeredExecution => "Event Triggered Execution",
            PrivilegeEscalation::AccessTokenManipulation => "Access Token Manipulation",
            PrivilegeEscalation::DomainPolicyModification => "Domain Policy Modification",
        })
    }
}
impl fmt::Display for LateralMovement {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str(match self {
            LateralMovement::TaintSharedContent => "Taint Shared Content",
            LateralMovement::ReplicationThroughRemovableMedia => "Replication Through Removable Media",
            LateralMovement::UseAlternateAuthenticationMaterial => "Use Alternate Authentication Material",
            LateralMovement::RemoteServices => "Remote Services",
            LateralMovement::RemoteServiceSessionHijacking => "Remote Service Session Hijacking",
            LateralMovement::SoftwareDeploymentTools => "Software Deployment Tools",
            LateralMovement::ExploitationOfRemoteServices => "Exploitation of Remote Services",
            LateralMovement::InternalSpearphishing => "Internal Spearphishing",
            LateralMovement::LateralToolTransfer => "Lateral Tool Transfer",
        })
    }
}
impl fmt::Display for DefenseEvasion {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str(match self {
            DefenseEvasion::DirectVolumeAccess => "Direct Volume Access",
            DefenseEvasion::Rootkit => "Rootkit",
            DefenseEvasion::ModifyCloudComputeInfrastructure => "Modify Cloud Compute Infrastructure",
            DefenseEvasion::WeakenEncryption => "Weaken Encryption",
            DefenseEvasion::HideArtifacts => "Hide Artifacts",
            DefenseEvasion::IndirectCommandExecution => "Indirect Command Execution",
            DefenseEvasion::DeobfuscateDecodeFilesOrInformation => "Deobfuscate/Decode Files or Information",
            DefenseEvasion::ImpairDefenses => "Impair Defenses",
            DefenseEvasion::Masquerading => "Masquerading",
            DefenseEvasion::ProcessInjection => "Process Injection",
            DefenseEvasion::TrafficSignaling => "Traffic Signaling",
            DefenseEvasion::SystemBinaryProxyExecution => "System Binary Proxy Execution",
            DefenseEvasion::ReflectiveCodeLoading => "Reflective Code Loading",
            DefenseEvasion::UseAlternateAuthenticationMaterial => "Use Alternate Authentication Material",
            DefenseEvasion::RogueDomainController => "Rogue Domain Controller",
            DefenseEvasion::DeployContainer => "Deploy Container",
            DefenseEvasion::ModifyRegistry => "Modify Registry",
            DefenseEvasion::UnusedUnsupportedCloudRegions => "Unused/Unsupported Cloud Regions",
            DefenseEvasion::FileAndDirectoryPermissionsModification => "File and Directory Permissions Modification",
            DefenseEvasion::AbuseElevationControlMechanism => "Abuse Elevation Control Mechanism",
            DefenseEvasion::IndicatorRemoval => "Indicator Removal",
            DefenseEvasion::PlistFileModification => "Plist File Modification",
            DefenseEvasion::PreOsBoot => "Pre-OS Boot",
            DefenseEvasion::BuildImageOnHost => "Build Image on Host",
            DefenseEvasion::VirtualizationSandboxEvasion => "Virtualization/Sandbox Evasion",
            DefenseEvasion::ExecutionGuardrails => "Execution Guardrails",
            DefenseEvasion::ModifySystemImage => "Modify System Image",
            DefenseEvasion::HijackExecutionFlow => "Hijack Execution Flow",
            DefenseEvasion::ValidAccounts => "Valid Accounts",
            DefenseEvasion::ObfuscatedFilesOrInformation => "Obfuscated Files or Information",
            DefenseEvasion::NetworkBoundaryBridging => "Network Boundary Bridging",
            DefenseEvasion::SubvertTrustControls => "Subvert Trust Controls",
            DefenseEvasion::BitsJobs => "BITS Jobs",
            DefenseEvasion::Impersonation => "Impersonation",
            DefenseEvasion::TemplateInjection => "Template Injection",
            DefenseEvasion::AccessTokenManipulation => "Access Token Manipulation",
            DefenseEvasion::DebuggerEvasion => "Debugger Evasion",
            DefenseEvasion::DomainPolicyModification => "Domain Policy Modification",
            DefenseEvasion::XslScriptProcessing => "XSL Script Processing",
            DefenseEvasion::ModifyAuthenticationProcess => "Modify Authentication Process",
            DefenseEvasion::SystemScriptProxyExecution => "System Script Proxy Execution",
            DefenseEvasion::ExploitationForDefenseEvasion => "Exploitation for Defense Evasion",
            DefenseEvasion::TrustedDeveloperUtilitiesProxyExecution => "Trusted Developer Utilities Proxy Execution",
        })
    }
}
impl fmt::Display for Exfiltration {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str(match self {
            Exfiltration::ExfiltrationOverWebService => "Exfiltration Over Web Service",
            Exfiltration::ScheduledTransfer => "Scheduled Transfer",
            Exfiltration::ExfiltrationOverOtherNetworkMedium => "Exfiltration Over Other Network Medium",
            Exfiltration::AutomatedExfiltration => "Automated Exfiltration",
            Exfiltration::ExfiltrationOverC2Channel => "Exfiltration Over C2 Channel",
            Exfiltration::ExfiltrationOverAlternativeProtocol => "Exfiltration Over Alternative Protocol",
            Exfiltration::DataTransferSizeLimits => "Data Transfer Size Limits",
            Exfiltration::TransferDataToCloudAccount => "Transfer Data to Cloud Account",
            Exfiltration::ExfiltrationOverPhysicalMedium => "Exfiltration Over Physical Medium",
        })
    }
}
impl fmt::Display for Discovery {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str(match self {
            Discovery::SystemOwnerUserDiscovery => "System Owner/User Discovery",
            Discovery::ContainerAndResourceDiscovery => "Container and Resource Discovery",
            Discovery::PermissionGroupsDiscovery => "Permission Groups Discovery",
            Discovery::GroupPolicyDiscovery => "Group Policy Discovery",
            Discovery::DeviceDriverDiscovery => "Device Driver Discovery",
            Discovery::SystemServiceDiscovery => "System Service Discovery",
            Discovery::NetworkSniffing => "Network Sniffing",
            Discovery::NetworkShareDiscovery => "Network Share Discovery",
            Discovery::PeripheralDeviceDiscovery => "Peripheral Device Discovery",
            Discovery::SystemInformationDiscovery => "System Information Discovery",
            Discovery::ApplicationWindowDiscovery => "Application Window Discovery",
            Discovery::CloudInfrastructureDiscovery => "Cloud Infrastructure Discovery",
            Discovery::BrowserInformationDiscovery => "Browser Information Discovery",
            Discovery::SystemNetworkConfigurationDiscovery => "System Network Configuration Discovery",
            Discovery::AccountDiscovery => "Account Discovery",
            Discovery::DomainTrustDiscovery => "Domain Trust Discovery",
            Discovery::FileAndDirectoryDiscovery => "File and Directory Discovery",
            Discovery::SystemNetworkConnectionsDiscovery => "System Network Connections Discovery",
            Discovery::VirtualizationSandboxEvasion => "Virtualization/Sandbox Evasion",
            Discovery::CloudStorageObjectDiscovery => "Cloud Storage Object Discovery",
            Discovery::LogEnumeration => "Log Enumeration",
            Discovery::ProcessDiscovery => "Process Discovery",
            Discovery::PasswordPolicyDiscovery => "Password Policy Discovery",
            Discovery::QueryRegistry => "Query Registry",
            Discovery::SystemLocationDiscovery => "System Location Discovery",
            Discovery::CloudServiceDiscovery => "Cloud Service Discovery",
            Discovery::RemoteSystemDiscovery => "Remote System Discovery",
            Discovery::NetworkServiceDiscovery => "Network Service Discovery",
            Discovery::SoftwareDiscovery => "Software Discovery",
            Discovery::CloudServiceDashboard => "Cloud Service Dashboard",
            Discovery::DebuggerEvasion => "Debugger Evasion",
...
impl fmt::Display for Collection {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str(match self {
            Collection::ScreenCapture => "Screen Capture",
            Collection::AdversaryInTheMiddle => "Adversary-in-the-Middle",
            Collection::DataFromConfigurationRepository => "Data from Configuration Repository",
            Collection::AudioCapture => "Audio Capture",
            Collection::EmailCollection => "Email Collection",
            Collection::DataFromRemovableMedia => "Data from Removable Media",
            Collection::AutomatedCollection => "Automated Collection",
            Collection::ClipboardData => "Clipboard Data",
            Collection::DataFromCloudStorage => "Data from Cloud Storage",
            Collection::DataFromLocalSystem => "Data from Local System",
            Collection::ArchiveCollectedData => "Archive Collected Data",
            Collection::BrowserSessionHijacking => "Browser Session Hijacking",
            Collection::VideoCapture => "Video Capture",
            Collection::DataStaged => "Data Staged",
            Collection::DataFromNetworkSharedDrive => "Data from Network Shared Drive",
            Collection::InputCapture => "Input Capture",
            Collection::DataFromInformationRepositories => "Data from Information Repositories",
        })
    }
}
impl fmt::Display for ResourceDevelopment {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str(match self {
            ResourceDevelopment::AcquireInfrastructure => "Acquire Infrastructure",
            ResourceDevelopment::CompromiseInfrastructure => "Compromise Infrastructure",
            ResourceDevelopment::CompromiseAccounts => "Compromise Accounts",
            ResourceDevelopment::StageCapabilities => "Stage Capabilities",
            ResourceDevelopment::EstablishAccounts => "Establish Accounts",
            ResourceDevelopment::ObtainCapabilities => "Obtain Capabilities",
            ResourceDevelopment::AcquireAccess => "Acquire Access",
            ResourceDevelopment::DevelopCapabilities => "Develop Capabilities",
        })
    }
}
impl fmt::Display for Reconnaissance {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str(match self {
            Reconnaissance::GatherVictimHostInformation => "Gather Victim Host Information",
            Reconnaissance::SearchVictimOwnedWebsites => "Search Victim-Owned Websites",
            Reconnaissance::GatherVictimIdentityInformation => "Gather Victim Identity Information",
            Reconnaissance::SearchOpenTechnicalDatabases => "Search Open Technical Databases",
            Reconnaissance::ActiveScanning => "Active Scanning",
            Reconnaissance::GatherVictimOrgInformation => "Gather Victim Org Information",
            Reconnaissance::GatherVictimNetworkInformation => "Gather Victim Network Information",
            Reconnaissance::SearchOpenWebsitesDomains => "Search Open Websites/Domains",
            Reconnaissance::SearchClosedSources => "Search Closed Sources",
            Reconnaissance::PhishingForInformation => "Phishing for Information",
        })
    }
}
impl fmt::Display for CommandAndControl {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str(match self {
            CommandAndControl::ApplicationLayerProtocol => "Application Layer Protocol",
            CommandAndControl::RemoteAccessSoftware => "Remote Access Software",
            CommandAndControl::ContentInjection => "Content Injection",
            CommandAndControl::TrafficSignaling => "Traffic Signaling",
            CommandAndControl::ProtocolTunneling => "Protocol Tunneling",
            CommandAndControl::CommunicationThroughRemovableMedia => "Communication Through Removable Media",
            CommandAndControl::Proxy => "Proxy",
            CommandAndControl::DynamicResolution => "Dynamic Resolution",
            CommandAndControl::WebService => "Web Service",
            CommandAndControl::MultiStageChannels => "Multi-Stage Channels",
            CommandAndControl::DataObfuscation => "Data Obfuscation",
            CommandAndControl::NonStandardPort => "Non-Standard Port",
            CommandAndControl::EncryptedChannel => "Encrypted Channel",
            CommandAndControl::NonApplicationLayerProtocol => "Non-Application Layer Protocol",
            CommandAndControl::DataEncoding => "Data Encoding",
            CommandAndControl::IngressToolTransfer => "Ingress Tool Transfer",
            CommandAndControl::FallbackChannels => "Fallback Channels",
        })
    }
}
impl fmt::Display for InitialAccess {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        f.write_str(match self {
            InitialAccess::ExternalRemoteServices => "External Remote Services",
            InitialAccess::ReplicationThroughRemovableMedia => "Replication Through Removable Media",
            InitialAccess::SupplyChainCompromise => "Supply Chain Compromise",
            InitialAccess::ExploitPublicFacingApplication => "Exploit Public-Facing Application",
            InitialAccess::ContentInjection => "Content Injection",
            InitialAccess::TrustedRelationship => "Trusted Relationship",
            InitialAccess::Phishing => "Phishing",
            InitialAccess::ValidAccounts => "Valid Accounts",
            InitialAccess::HardwareAdditions => "Hardware Additions",
            InitialAccess::DriveByCompromise => "Drive-by Compromise",
        })
    }
}
impl FromStr for Tactic {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Err(())
            .or_else(|_| CredentialAccess::from_str(s).map(Tactic::CredentialAccess))
            .or_else(|_| Execution::from_str(s).map(Tactic::Execution))
            .or_else(|_| Impact::from_str(s).map(Tactic::Impact))
            .or_else(|_| Persistence::from_str(s).map(Tactic::Persistence))
            .or_else(|_| PrivilegeEscalation::from_str(s).map(Tactic::PrivilegeEscalation))
            .or_else(|_| LateralMovement::from_str(s).map(Tactic::LateralMovement))
            .or_else(|_| DefenseEvasion::from_str(s).map(Tactic::DefenseEvasion))
            .or_else(|_| Exfiltration::from_str(s).map(Tactic::Exfiltration))
            .or_else(|_| Discovery::from_str(s).map(Tactic::Discovery))
            .or_else(|_| Collection::from_str(s).map(Tactic::Collection))
            .or_else(|_| ResourceDevelopment::from_str(s).map(Tactic::ResourceDevelopment))
            .or_else(|_| Reconnaissance::from_str(s).map(Tactic::Reconnaissance))
            .or_else(|_| CommandAndControl::from_str(s).map(Tactic::CommandAndControl))
            .or_else(|_| InitialAccess::from_str(s).map(Tactic::InitialAccess))
    }
}
impl FromStr for CredentialAccess {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "Adversary-in-the-Middle" => Ok(CredentialAccess::AdversaryInTheMiddle),
            "OS Credential Dumping" => Ok(CredentialAccess::OsCredentialDumping),
            "Steal Web Session Cookie" => Ok(CredentialAccess::StealWebSessionCookie),
            "Network Sniffing" => Ok(CredentialAccess::NetworkSniffing),
            "Steal or Forge Kerberos Tickets" => Ok(CredentialAccess::StealOrForgeKerberosTickets),
            "Credentials from Password Stores" => Ok(CredentialAccess::CredentialsFromPasswordStores),
            "Unsecured Credentials" => Ok(CredentialAccess::UnsecuredCredentials),
            "Steal or Forge Authentication Certificates" => Ok(CredentialAccess::StealOrForgeAuthenticationCertificates),
            "Steal Application Access Token" => Ok(CredentialAccess::StealApplicationAccessToken),
            "Forge Web Credentials" => Ok(CredentialAccess::ForgeWebCredentials),
            "Multi-Factor Authentication Request Generation" => Ok(CredentialAccess::MultiFactorAuthenticationRequestGeneration),
            "Exploitation for Credential Access" => Ok(CredentialAccess::ExploitationForCredentialAccess),
            "Brute Force" => Ok(CredentialAccess::BruteForce),
            "Forced Authentication" => Ok(CredentialAccess::ForcedAuthentication),
            "Input Capture" => Ok(CredentialAccess::InputCapture),
            "Multi-Factor Authentication Interception" => Ok(CredentialAccess::MultiFactorAuthenticationInterception),
            "Modify Authentication Process" => Ok(CredentialAccess::ModifyAuthenticationProcess),
            _ => Err(()),
        }
    }
}
impl FromStr for Execution {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "Windows Management Instrumentation" => Ok(Execution::WindowsManagementInstrumentation),
            "Shared Modules" => Ok(Execution::SharedModules),
            "Scheduled Task/Job" => Ok(Execution::ScheduledTaskJob),
            "Native API" => Ok(Execution::NativeApi),
            "Deploy Container" => Ok(Execution::DeployContainer),
            "Command and Scripting Interpreter" => Ok(Execution::CommandAndScriptingInterpreter),
            "Container Administration Command" => Ok(Execution::ContainerAdministrationCommand),
            "User Execution" => Ok(Execution::UserExecution),
            "Software Deployment Tools" => Ok(Execution::SoftwareDeploymentTools),
            "Inter-Process Communication" => Ok(Execution::InterProcessCommunication),
            "Exploitation for Client Execution" => Ok(Execution::ExploitationForClientExecution),
            "System Services" => Ok(Execution::SystemServices),
            "Cloud Administration Command" => Ok(Execution::CloudAdministrationCommand),
            "Serverless Execution" => Ok(Execution::ServerlessExecution),
            _ => Err(()),
        }
    }
}
impl FromStr for Impact {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "Disk Wipe" => Ok(Impact::DiskWipe),
            "Service Stop" => Ok(Impact::ServiceStop),
            "Defacement" => Ok(Impact::Defacement),
            "Financial Theft" => Ok(Impact::FinancialTheft),
            "Data Manipulation" => Ok(Impact::DataManipulation),
            "Account Access Removal" => Ok(Impact::AccountAccessRemoval),
            "Data Encrypted for Impact" => Ok(Impact::DataEncryptedForImpact),
            "Endpoint Denial of Service" => Ok(Impact::EndpointDenialOfService),
            "Resource Hijacking" => Ok(Impact::ResourceHijacking),
            "Data Destruction" => Ok(Impact::DataDestruction),
            "Network Denial of Service" => Ok(Impact::NetworkDenialOfService),
            "Firmware Corruption" => Ok(Impact::FirmwareCorruption),
            "Inhibit System Recovery" => Ok(Impact::InhibitSystemRecovery),
            "System Shutdown/Reboot" => Ok(Impact::SystemShutdownReboot),
            _ => Err(()),
        }
    }
}
impl FromStr for Persistence {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "Boot or Logon Initialization Scripts" => Ok(Persistence::BootOrLogonInitializationScripts),
            "Create or Modify System Process" => Ok(Persistence::CreateOrModifySystemProcess),
            "External Remote Services" => Ok(Persistence::ExternalRemoteServices),
            "Boot or Logon Autostart Execution" => Ok(Persistence::BootOrLogonAutostartExecution),
            "Office Application Startup" => Ok(Persistence::OfficeApplicationStartup),
            "Scheduled Task/Job" => Ok(Persistence::ScheduledTaskJob),
            "Browser Extensions" => Ok(Persistence::BrowserExtensions),
            "Traffic Signaling" => Ok(Persistence::TrafficSignaling),
            "Implant Internal Image" => Ok(Persistence::ImplantInternalImage),
            "Pre-OS Boot" => Ok(Persistence::PreOsBoot),
            "Compromise Client Software Binary" => Ok(Persistence::CompromiseClientSoftwareBinary),
            "Account Manipulation" => Ok(Persistence::AccountManipulation),
            "Hijack Execution Flow" => Ok(Persistence::HijackExecutionFlow),
            "Valid Accounts" => Ok(Persistence::ValidAccounts),
            "Event Triggered Execution" => Ok(Persistence::EventTriggeredExecution),
            "BITS Jobs" => Ok(Persistence::BitsJobs),
            "Server Software Component" => Ok(Persistence::ServerSoftwareComponent),
            "Create Account" => Ok(Persistence::CreateAccount),
            "Power Settings" => Ok(Persistence::PowerSettings),
            "Modify Authentication Process" => Ok(Persistence::ModifyAuthenticationProcess),
            _ => Err(()),
        }
    }
}
impl FromStr for PrivilegeEscalation {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "Boot or Logon Initialization Scripts" => Ok(PrivilegeEscalation::BootOrLogonInitializationScripts),
            "Create or Modify System Process" => Ok(PrivilegeEscalation::CreateOrModifySystemProcess),
            "Boot or Logon Autostart Execution" => Ok(PrivilegeEscalation::BootOrLogonAutostartExecution),
            "Scheduled Task/Job" => Ok(PrivilegeEscalation::ScheduledTaskJob),
            "Process Injection" => Ok(PrivilegeEscalation::ProcessInjection),
            "Escape to Host" => Ok(PrivilegeEscalation::EscapeToHost),
            "Abuse Elevation Control Mechanism" => Ok(PrivilegeEscalation::AbuseElevationControlMechanism),
            "Account Manipulation" => Ok(PrivilegeEscalation::AccountManipulation),
            "Hijack Execution Flow" => Ok(PrivilegeEscalation::HijackExecutionFlow),
            "Valid Accounts" => Ok(PrivilegeEscalation::ValidAccounts),
            "Exploitation for Privilege Escalation" => Ok(PrivilegeEscalation::ExploitationForPrivilegeEscalation),
            "Event Triggered Execution" => Ok(PrivilegeEscalation::EventTriggeredExecution),
            "Access Token Manipulation" => Ok(PrivilegeEscalation::AccessTokenManipulation),
            "Domain Policy Modification" => Ok(PrivilegeEscalation::DomainPolicyModification),
            _ => Err(()),
        }
    }
}
impl FromStr for LateralMovement {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "Taint Shared Content" => Ok(LateralMovement::TaintSharedContent),
            "Replication Through Removable Media" => Ok(LateralMovement::ReplicationThroughRemovableMedia),
            "Use Alternate Authentication Material" => Ok(LateralMovement::UseAlternateAuthenticationMaterial),
            "Remote Services" => Ok(LateralMovement::RemoteServices),
            "Remote Service Session Hijacking" => Ok(LateralMovement::RemoteServiceSessionHijacking),
            "Software Deployment Tools" => Ok(LateralMovement::SoftwareDeploymentTools),
            "Exploitation of Remote Services" => Ok(LateralMovement::ExploitationOfRemoteServices),
            "Internal Spearphishing" => Ok(LateralMovement::InternalSpearphishing),
            "Lateral Tool Transfer" => Ok(LateralMovement::LateralToolTransfer),
            _ => Err(()),
        }
    }
}
impl FromStr for DefenseEvasion {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "Direct Volume Access" => Ok(DefenseEvasion::DirectVolumeAccess),
            "Rootkit" => Ok(DefenseEvasion::Rootkit),
            "Modify Cloud Compute Infrastructure" => Ok(DefenseEvasion::ModifyCloudComputeInfrastructure),
            "Weaken Encryption" => Ok(DefenseEvasion::WeakenEncryption),
            "Hide Artifacts" => Ok(DefenseEvasion::HideArtifacts),
            "Indirect Command Execution" => Ok(DefenseEvasion::IndirectCommandExecution),
            "Deobfuscate/Decode Files or Information" => Ok(DefenseEvasion::DeobfuscateDecodeFilesOrInformation),
            "Impair Defenses" => Ok(DefenseEvasion::ImpairDefenses),
            "Masquerading" => Ok(DefenseEvasion::Masquerading),
            "Process Injection" => Ok(DefenseEvasion::ProcessInjection),
            "Traffic Signaling" => Ok(DefenseEvasion::TrafficSignaling),
            "System Binary Proxy Execution" => Ok(DefenseEvasion::SystemBinaryProxyExecution),
            "Reflective Code Loading" => Ok(DefenseEvasion::ReflectiveCodeLoading),
            "Use Alternate Authentication Material" => Ok(DefenseEvasion::UseAlternateAuthenticationMaterial),
            "Rogue Domain Controller" => Ok(DefenseEvasion::RogueDomainController),
            "Deploy Container" => Ok(DefenseEvasion::DeployContainer),
            "Modify Registry" => Ok(DefenseEvasion::ModifyRegistry),
            "Unused/Unsupported Cloud Regions" => Ok(DefenseEvasion::UnusedUnsupportedCloudRegions),
            "File and Directory Permissions Modification" => Ok(DefenseEvasion::FileAndDirectoryPermissionsModification),
            "Abuse Elevation Control Mechanism" => Ok(DefenseEvasion::AbuseElevationControlMechanism),
            "Indicator Removal" => Ok(DefenseEvasion::IndicatorRemoval),
            "Plist File Modification" => Ok(DefenseEvasion::PlistFileModification),
            "Pre-OS Boot" => Ok(DefenseEvasion::PreOsBoot),
            "Build Image on Host" => Ok(DefenseEvasion::BuildImageOnHost),
            "Virtualization/Sandbox Evasion" => Ok(DefenseEvasion::VirtualizationSandboxEvasion),
            "Execution Guardrails" => Ok(DefenseEvasion::ExecutionGuardrails),
            "Modify System Image" => Ok(DefenseEvasion::ModifySystemImage),
            "Hijack Execution Flow" => Ok(DefenseEvasion::HijackExecutionFlow),
            "Valid Accounts" => Ok(DefenseEvasion::ValidAccounts),
            "Obfuscated Files or Information" => Ok(DefenseEvasion::ObfuscatedFilesOrInformation),
            "Network Boundary Bridging" => Ok(DefenseEvasion::NetworkBoundaryBridging),
            "Subvert Trust Controls" => Ok(DefenseEvasion::SubvertTrustControls),
            "BITS Jobs" => Ok(DefenseEvasion::BitsJobs),
            "Impersonation" => Ok(DefenseEvasion::Impersonation),
            "Template Injection" => Ok(DefenseEvasion::TemplateInjection),
            "Access Token Manipulation" => Ok(DefenseEvasion::AccessTokenManipulation),
            "Debugger Evasion" => Ok(DefenseEvasion::DebuggerEvasion),
            "Domain Policy Modification" => Ok(DefenseEvasion::DomainPolicyModification),
            "XSL Script Processing" => Ok(DefenseEvasion::XslScriptProcessing),
            "Modify Authentication Process" => Ok(DefenseEvasion::ModifyAuthenticationProcess),
            "System Script Proxy Execution" => Ok(DefenseEvasion::SystemScriptProxyExecution),
            "Exploitation for Defense Evasion" => Ok(DefenseEvasion::ExploitationForDefenseEvasion),
            "Trusted Developer Utilities Proxy Execution" => Ok(DefenseEvasion::TrustedDeveloperUtilitiesProxyExecution),
            _ => Err(()),
        }
    }
}
impl FromStr for Exfiltration {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "Exfiltration Over Web Service" => Ok(Exfiltration::ExfiltrationOverWebService),
            "Scheduled Transfer" => Ok(Exfiltration::ScheduledTransfer),
            "Exfiltration Over Other Network Medium" => Ok(Exfiltration::ExfiltrationOverOtherNetworkMedium),
            "Automated Exfiltration" => Ok(Exfiltration::AutomatedExfiltration),
            "Exfiltration Over C2 Channel" => Ok(Exfiltration::ExfiltrationOverC2Channel),
            "Exfiltration Over Alternative Protocol" => Ok(Exfiltration::ExfiltrationOverAlternativeProtocol),
            "Data Transfer Size Limits" => Ok(Exfiltration::DataTransferSizeLimits),
            "Transfer Data to Cloud Account" => Ok(Exfiltration::TransferDataToCloudAccount),
            "Exfiltration Over Physical Medium" => Ok(Exfiltration::ExfiltrationOverPhysicalMedium),
            _ => Err(()),
        }
    }
}
impl FromStr for Discovery {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "System Owner/User Discovery" => Ok(Discovery::SystemOwnerUserDiscovery),
            "Container and Resource Discovery" => Ok(Discovery::ContainerAndResourceDiscovery),
            "Permission Groups Discovery" => Ok(Discovery::PermissionGroupsDiscovery),
            "Group Policy Discovery" => Ok(Discovery::GroupPolicyDiscovery),
            "Device Driver Discovery" => Ok(Discovery::DeviceDriverDiscovery),
            "System Service Discovery" => Ok(Discovery::SystemServiceDiscovery),
            "Network Sniffing" => Ok(Discovery::NetworkSniffing),
            "Network Share Discovery" => Ok(Discovery::NetworkShareDiscovery),
            "Peripheral Device Discovery" => Ok(Discovery::PeripheralDeviceDiscovery),
            "System Information Discovery" => Ok(Discovery::SystemInformationDiscovery),
            "Application Window Discovery" => Ok(Discovery::ApplicationWindowDiscovery),
            "Cloud Infrastructure Discovery" => Ok(Discovery::CloudInfrastructureDiscovery),
            "Browser Information Discovery" => Ok(Discovery::BrowserInformationDiscovery),
            "System Network Configuration Discovery" => Ok(Discovery::SystemNetworkConfigurationDiscovery),
            "Account Discovery" => Ok(Discovery::AccountDiscovery),
            "Domain Trust Discovery" => Ok(Discovery::DomainTrustDiscovery),
            "File and Directory Discovery" => Ok(Discovery::FileAndDirectoryDiscovery),
            "System Network Connections Discovery" => Ok(Discovery::SystemNetworkConnectionsDiscovery),
            "Virtualization/Sandbox Evasion" => Ok(Discovery::VirtualizationSandboxEvasion),
            "Cloud Storage Object Discovery" => Ok(Discovery::CloudStorageObjectDiscovery),
            "Log Enumeration" => Ok(Discovery::LogEnumeration),
            "Process Discovery" => Ok(Discovery::ProcessDiscovery),
            "Password Policy Discovery" => Ok(Discovery::PasswordPolicyDiscovery),
            "Query Registry" => Ok(Discovery::QueryRegistry),
            "System Location Discovery" => Ok(Discovery::SystemLocationDiscovery),
            "Cloud Service Discovery" => Ok(Discovery::CloudServiceDiscovery),
            "Remote System Discovery" => Ok(Discovery::RemoteSystemDiscovery),
            "Network Service Discovery" => Ok(Discovery::NetworkServiceDiscovery),
            "Software Discovery" => Ok(Discovery::SoftwareDiscovery),
            "Cloud Service Dashboard" => Ok(Discovery::CloudServiceDashboard),
            "Debugger Evasion" => Ok(Discovery::DebuggerEvasion),
            "System Time Discovery" => Ok(Discovery::SystemTimeDiscovery),
            _ => Err(()),
        }
    }
}
impl FromStr for Collection {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "Screen Capture" => Ok(Collection::ScreenCapture),
            "Adversary-in-the-Middle" => Ok(Collection::AdversaryInTheMiddle),
            "Data from Configuration Repository" => Ok(Collection::DataFromConfigurationRepository),
            "Audio Capture" => Ok(Collection::AudioCapture),
            "Email Collection" => Ok(Collection::EmailCollection),
            "Data from Removable Media" => Ok(Collection::DataFromRemovableMedia),
            "Automated Collection" => Ok(Collection::AutomatedCollection),
            "Clipboard Data" => Ok(Collection::ClipboardData),
            "Data from Cloud Storage" => Ok(Collection::DataFromCloudStorage),
            "Data from Local System" => Ok(Collection::DataFromLocalSystem),
            "Archive Collected Data" => Ok(Collection::ArchiveCollectedData),
            "Browser Session Hijacking" => Ok(Collection::BrowserSessionHijacking),
            "Video Capture" => Ok(Collection::VideoCapture),
            "Data Staged" => Ok(Collection::DataStaged),
            "Data from Network Shared Drive" => Ok(Collection::DataFromNetworkSharedDrive),
            "Input Capture" => Ok(Collection::InputCapture),
            "Data from Information Repositories" => Ok(Collection::DataFromInformationRepositories),
            _ => Err(()),
        }
    }
}
impl FromStr for ResourceDevelopment {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "Acquire Infrastructure" => Ok(ResourceDevelopment::AcquireInfrastructure),
            "Compromise Infrastructure" => Ok(ResourceDevelopment::CompromiseInfrastructure),
            "Compromise Accounts" => Ok(ResourceDevelopment::CompromiseAccounts),
            "Stage Capabilities" => Ok(ResourceDevelopment::StageCapabilities),
            "Establish Accounts" => Ok(ResourceDevelopment::EstablishAccounts),
            "Obtain Capabilities" => Ok(ResourceDevelopment::ObtainCapabilities),
            "Acquire Access" => Ok(ResourceDevelopment::AcquireAccess),
            "Develop Capabilities" => Ok(ResourceDevelopment::DevelopCapabilities),
            _ => Err(()),
        }
    }
}
impl FromStr for Reconnaissance {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "Gather Victim Host Information" => Ok(Reconnaissance::GatherVictimHostInformation),
            "Search Victim-Owned Websites" => Ok(Reconnaissance::SearchVictimOwnedWebsites),
            "Gather Victim Identity Information" => Ok(Reconnaissance::GatherVictimIdentityInformation),
            "Search Open Technical Databases" => Ok(Reconnaissance::SearchOpenTechnicalDatabases),
            "Active Scanning" => Ok(Reconnaissance::ActiveScanning),
            "Gather Victim Org Information" => Ok(Reconnaissance::GatherVictimOrgInformation),
            "Gather Victim Network Information" => Ok(Reconnaissance::GatherVictimNetworkInformation),
            "Search Open Websites/Domains" => Ok(Reconnaissance::SearchOpenWebsitesDomains),
            "Search Closed Sources" => Ok(Reconnaissance::SearchClosedSources),
            "Phishing for Information" => Ok(Reconnaissance::PhishingForInformation),
            _ => Err(()),
        }
    }
}
impl FromStr for CommandAndControl {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "Application Layer Protocol" => Ok(CommandAndControl::ApplicationLayerProtocol),
            "Remote Access Software" => Ok(CommandAndControl::RemoteAccessSoftware),
            "Content Injection" => Ok(CommandAndControl::ContentInjection),
            "Traffic Signaling" => Ok(CommandAndControl::TrafficSignaling),
            "Protocol Tunneling" => Ok(CommandAndControl::ProtocolTunneling),
            "Communication Through Removable Media" => Ok(CommandAndControl::CommunicationThroughRemovableMedia),
            "Proxy" => Ok(CommandAndControl::Proxy),
            "Dynamic Resolution" => Ok(CommandAndControl::DynamicResolution),
            "Web Service" => Ok(CommandAndControl::WebService),
            "Multi-Stage Channels" => Ok(CommandAndControl::MultiStageChannels),
            "Data Obfuscation" => Ok(CommandAndControl::DataObfuscation),
            "Non-Standard Port" => Ok(CommandAndControl::NonStandardPort),
            "Encrypted Channel" => Ok(CommandAndControl::EncryptedChannel),
            "Non-Application Layer Protocol" => Ok(CommandAndControl::NonApplicationLayerProtocol),
            "Data Encoding" => Ok(CommandAndControl::DataEncoding),
            "Ingress Tool Transfer" => Ok(CommandAndControl::IngressToolTransfer),
            "Fallback Channels" => Ok(CommandAndControl::FallbackChannels),
            _ => Err(()),
        }
    }
}
impl FromStr for InitialAccess {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            "External Remote Services" => Ok(InitialAccess::ExternalRemoteServices),
            "Replication Through Removable Media" => Ok(InitialAccess::ReplicationThroughRemovableMedia),
            "Supply Chain Compromise" => Ok(InitialAccess::SupplyChainCompromise),
            "Exploit Public-Facing Application" => Ok(InitialAccess::ExploitPublicFacingApplication),
            "Content Injection" => Ok(InitialAccess::ContentInjection),
            "Trusted Relationship" => Ok(InitialAccess::TrustedRelationship),
            "Phishing" => Ok(InitialAccess::Phishing),
            "Valid Accounts" => Ok(InitialAccess::ValidAccounts),
            "Hardware Additions" => Ok(InitialAccess::HardwareAdditions),
            "Drive-by Compromise" => Ok(InitialAccess::DriveByCompromise),
            _ => Err(()),
        }
    }
}
